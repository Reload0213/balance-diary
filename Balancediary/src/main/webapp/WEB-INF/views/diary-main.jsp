...
<link rel="stylesheet" href="resources/css/diary/diaryMain.css">
...
/* main */
#diary-main {
	background: url(resources/images/diary-main/diary-main.jpg) no-repeat;
...
.our-diary {
	width: 100%;
	height: 70vw;
	background: url(resources/images/diary-main/our-diary-board.jpg)
		no-repeat;
	background-size: cover;
	z-index: -10;
	position: relative;
