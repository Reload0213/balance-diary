...
#qa-top-wrap {
	width: 100%;
	height: 1000px;
	background: url(resources/images/Q&A-Images/q&a-bg.png) no-repeat;
			...
			<section id="qa-container">
				...
				<section id="qa-content">
					...
					<article id="avoid-fat">
						...
						<img src="resources/images/Q&A-Images/fatforbody.png"
						...
						<img src="resources/images/Q&A-Images/3rd-nutrition.png"
							alt="다이어트시 지방은 무조건 피해야한다?">
					</article>
					<article id="avoid-carb">
						...
						<p>- 지방도 탄수화물도 조절이 필요한건 맞지만, 꼭 필요한 영양소이며 같은 영양소라도 좋은 영양급원으로
							적절하게 섭취해줘야한다.</p>
						<img src="resources/images/Q&A-Images/diet-carb.png"
					...
					<article id="medison">
						...
						<img src="resources/images/Q&A-Images/medison.png"
					...
					<article id="breakfast">
						...
						<img src="resources/images/Q&A-Images/breakfast.png"
					...
					<article id="water">
						...
						<img src="resources/images/Q&A-Images/water.png"
					...
					<article id="fruit">
						...
						<img src="resources/images/Q&A-Images/fruit.png"
